...
def context(state):
 ...
 for o in state.get('options',[]):
  ...
  if 'Heal' in v:d['healing_if_present_in_this_option']=min(maximum-hp,v['Heal'])
  if 'HpLoss' in v:d['remaining_hp_if_this_option_loses_hp']=hp-v['HpLoss']
  out['options'].append(d)
