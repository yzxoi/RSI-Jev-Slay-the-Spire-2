...
def main():
 p=argparse.ArgumentParser();p.add_argument('--run-id',required=True);p.add_argument('--action');p.add_argument('--reason');p.add_argument('--output');p.add_argument('--max-actions',type=int,default=2000);p.add_argument('--review-cards',default='');p.add_argument('--danger-hp',type=int,default=35);p.add_argument('--combat-policy',choices=['planned','jev'],default='planned');a=p.parse_args();manifest=version_manifest()
