...
The Shockwave card was selected in native state with SHA-256 trace `48833e04f25d55a8c34e4fc6efcd76866c192447385cffe859aafcd03e9b5dad`; the fresh hand shows it playable at index 5 with zero energy cost. Astra precommitted [floor11-turn5-play-shockwave-choice.json](floor11-turn5-play-shockwave-choice.json) as the next opener, then the controller will resume under a same-turn review lease.
