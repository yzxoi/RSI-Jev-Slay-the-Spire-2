...
Final scope is evaluation infrastructure only. E020 was closed for no demonstrated benefit. Remove its optional policy/lesson from this PR final tree, retarget to E018; its complete implementation/results remain on closed PR36 and in tested historical commit15a52fd. Reproducing the treatment comparison requires that fixed commit. Final HEAD supports matched decisions with existing policies and does not promote E020.
