"""E066 preregistered paired funded-shop relic evaluation."""
...
def main():
    ...
    output = {'schema_version': 1, 'experiment': 'E066', 'manifest': manifest,
    ...
    Path('experiments/E066/result.json').write_text(json.dumps(output, ensure_ascii=False, indent=2) + '\n')
