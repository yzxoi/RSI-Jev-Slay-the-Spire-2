"""E088: matched A10 complete runs with a threat-timed potion spend budget."""
...
SEEDS = [f'e088_budget_{number:03}' for number in range(1, 5)]
...
def main():
    ...
    output = {
        'schema_version': 1, 'experiment': 'E088', 'manifest': manifest,
    ...
    Path('experiments/E088/result.json').write_text(json.dumps(output, ensure_ascii=False, indent=2) + '\n')
    print(json.dumps({
