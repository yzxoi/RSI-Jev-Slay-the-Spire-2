...
report={'manifest':manifest,'results':results,'scope':'frozen observed combat projections only; unexported RNG/pile contents not yet checked'};(ROOT/'experiments/E005/replay-v3.json').write_text(json.dumps(report,indent=2)+'\n');print(json.dumps(results,ensure_ascii=False))
