"""Preregistered E026 paired A0 development cohort."""
import json
...
configs=[dict(character='Ironclad',ascension=0,seed=f'a0_e026_dev_{i:03}',policy=p,max_steps=1500,max_seconds=300)for i in range(1,4)for p in ['triggered','horizon']]
...
Path('experiments/E026/development-v1.json').write_text(json.dumps(out,indent=2)+'\n')
