"""E073 preregistered paired full-run test of a stronger combat HP-loss penalty."""
...
SEEDS = [f'e073_lowhp_{n:03}' for n in range(1, 5)]
...
def main():
    ...
    output = {'schema_version': 1, 'experiment': 'E073', 'manifest': manifest,
    ...
    Path('experiments/E073/result.json').write_text(json.dumps(output, ensure_ascii=False, indent=2) + '\n')
