...
[E102](experiments/E102/README.md)在两项保障都开启后比较静态计划与 Astra 每回合建议：两个开发 Boss 局面从 1/2 到 2/2，铁甲两组均剩 43 血，猎手从战败到剩 8 血。动态组普通动作仍由 Jev 选择，共需 15 份专家建议；Astra 实际 token/费用未知。猎手仍两次漏执行防御并提前结束回合，逐回合建议尚不是可靠执行保障。保留为可选实验能力；[E103 提案](https://github.com/yzxoi/RSI-Jev-Slay-the-Spire-2/issues/198)将检查这种结束回合时的缺口，尚未执行。E100–E102 共 28 次 Boss 续局，但只有两个相关历史入口，不能当作 28 个独立种子或整局胜率。
